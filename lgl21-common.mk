...
# This file includes all definitions that apply to ALL lgl21-common devices, and
# are also specific to lgl21-common devices
#
# Everything in this directory will become public
#
$(call inherit-product, device/lge/gproj-common-lgl21/gproj.mk)
...
# Ramdisk
PRODUCT_COPY_FILES += \
##        $(LOCAL_PATH)/ramdisk/init.geehdc-common.rc:root/init.geehdc-common.rc \
...
# Thermal Daemon
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/configs/thermald-lgl21.conf:system/etc/thermald.conf

# Non-Ramdisk Init Scripts
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/scripts/init.geehdc.bt.sh:system/etc/init.geehdc.bt.sh \
